...
| 172-196 | `.main-action-surface-body-background` and `::after` | Custom canvas action background with fixed `124vw` glow and `1929 / 1255` ratio. Strongly opinionated visual layer. |
