...
- [0042 — Surface Deployment Failure Reasons Behind a Per-Runner Scrub Gate](0042-surface-scrubbed-deployment-failure-reasons.md) *(billing reverse-check and its raw-display exception added by ADR-0068; apply-boundary billing denial classifier added by ADR-0072)*
...
- [0079 — Model Public Entry Points as Deployment Access Endpoints](0079-model-public-entry-points-as-deployment-access-endpoints.md) *(revises ADR-0078's address and success-copy contract; public-URL display amended 2026-09-17 so a WS marker adds a sibling and does not hide HTTP(S))*
