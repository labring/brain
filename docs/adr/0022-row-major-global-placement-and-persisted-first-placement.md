# Use Row-Major Global Placement and Persist First Canvas Placements
...
This record absorbs ADR-0021 (Persist First Incremental Canvas Placements), whose persistence rule is stated above unchanged; 0021 is not reused.
