...
The Private Addresses section manages App Listening Ports using the Domain List row pattern without status icons. The Domain List and EntryPoint Public Addresses Panel remain public-routing surfaces; they may add App Listening Ports as part of Public Address edits, but they do not display Private Addresses.
