...
function publishDeploymentTaskProjectionEvent(
  event: DeploymentTaskProjectionStreamEvent
) {
...
export function publishDeploymentTaskProjectionChange(task: DeployTaskDTO) {
  ...
  if (projection == null) {
    publishDeploymentTaskProjectionEvent({
