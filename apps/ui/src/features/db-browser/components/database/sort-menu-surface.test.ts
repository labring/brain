...
const sortMenuFiles = [
  {
    ...
    path: "apps/ui/src/features/db-browser/components/database/sql/TableView/TableView.ColumnHeader.tsx",
  },
  {
    label: "Redis key column header",
    path: "apps/ui/src/features/db-browser/components/database/redis/RedisKeyDetailView.tsx",
  },
] as const;
...
const dataViewSortMenuSource = readFileSync(
  "apps/ui/src/features/db-browser/components/database/shared/DataViewSortMenu.tsx",
  "utf8"
);
