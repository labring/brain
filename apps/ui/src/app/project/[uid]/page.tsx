...
import { ProjectRuntimeNodeModelsProvider } from "@/features/project-runtime/resource-models-react";
    ...
    <div className="flex min-h-0 w-full flex-1 flex-col">
      {projectCanvas.canvas.frameState.renderCanvas && (
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          >
            <ProjectRuntimeNodeModelsProvider
              models={projectCanvas.canvas.runtimeNodeModels}
            >
              <Canvas.Root
                key={`${namespace}:${uid}`}
