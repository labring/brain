...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:w-fit group-[.is-user]:rounded-3xl group-[.is-user]:rounded-br-md group-[.is-user]:border group-[.is-user]:border-border/60 group-[.is-user]:bg-input/30 group-[.is-user]:px-4 group-[.is-user]:py-2.5 group-[.is-user]:text-foreground",
