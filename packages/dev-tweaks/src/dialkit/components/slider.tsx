/* eslint-disable react-hooks/refs, react-hooks/set-state-in-effect -- ported DialKit render-update patterns kept structurally intact */
...
export function Slider({
  ...
  return (
    <div className="dialkit-slider-wrapper" ref={wrapperRef}>
      <motion.div
      ...
      >
        ...
        <span className="dialkit-slider-label" ref={labelRef}>
          {label}
          {shortcut && (
            <span
