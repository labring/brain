...
const HOST_CLASS = "dialkit-frame-host";
/** Applied only while frame posture is docking the page. */
const FRAMED_CLASS = "dialkit-framed";

const GAP_VAR = "--dialkit-frame-gap";
const PANEL_W_VAR = "--dialkit-frame-panel-w";
const DURATION_VAR = "--dialkit-frame-ms";
